...
<outfunc> ::= OUT BRACKET_OPEN <expression> BRACKET_CLOSE SEMICOLOM
    */
    ...
    // // parserDFA->buildTable(ASSIGNMENT);
    // parserDFA->saveTable("../DFAs/parser/no.txt", "../DFAs/parser/parserSets.txt", "../DFAs/parser/parserRules.txt");
    parserDFA->loadTable("../DFAs/parser/parserDFA.txt", "../DFAs/parser/parserRules.txt");
